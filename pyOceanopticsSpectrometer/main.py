...
def main():
    ...
    view = gui(interface = Interface, parent=window, is_main_window = False, plot=True) #is_main_window = True tells the GUI that it is not contained inside another window
    window.show()
